...
?>
    ...
    <footer class="site-footer">
        <div class="shell site-footer__grid">
            <section>
                <h2 class="footer-title"><?php esc_html_e('Mobile brake service designed around your day.', 'quick-brake-repair-theme'); ?></h2>
                <p class="footer-copy"><?php esc_html_e('ASE-certified technicians, on-site repair support, and clear next steps before you drive again.', 'quick-brake-repair-theme'); ?></p>
            </section>
            <section>
                <h2 class="footer-list-title"><?php esc_html_e('Contact', 'quick-brake-repair-theme'); ?></h2>
            ...
            <section>
                <h2 class="footer-list-title"><?php esc_html_e('Service Areas', 'quick-brake-repair-theme'); ?></h2>
                <ul class="footer-list">
            ...
            <section>
                <h2 class="footer-list-title"><?php esc_html_e('Resources', 'quick-brake-repair-theme'); ?></h2>
                <ul class="footer-list">
                    <?php foreach (array_slice($resource_items, 0, $footer_resource_limit) as $article) : ?>
                        <li>
